...
const Login = () => {
    const { signinUser, signinWithGoogle, user ,signinWithGithub} = useContext(AuthContext)
    const {
        register,
        handleSubmit,
        formState: { errors },
      ...
      <div className='flex justify-center items-center  mt-16 font-Lato'>
        ...
        <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl '>
          <div
            ...
            style={{
              backgroundImage: `url('https://i.ibb.co/tBBGfhW/box-8702500-1280.jpg')`,
            }}
          ></div>
          ...
          <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
            ...
            <button onClick={() => signinWithGithub()} className="btn-circle border-none bg-transparent  text-2xl"><FaSquareGithub /></button>  
            </div>
