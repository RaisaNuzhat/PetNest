const AboutUs = () => {
    return (
        <div className="container mx-auto my-10 font-Lato text-center flex flex-col justify-center">
            <div className="bg-gray-100 p-10 rounded-lg shadow-lg">
                <h2 className="text-4xl font-bold mb-4 text-[#155263]">About Us</h2>
                ...
                <h3 className="text-2xl font-semibold mb-3 text-[#155263]">How It Works</h3>
                ...
                <h3 className="text-2xl font-semibold mb-3 text-[#155263]">Why We Were Made</h3>
                <p className="text-lg">
